        ...
        try {
            connection.createStatement()
                    .executeUpdate("CREATE TABLE " +
                            "Candle(id bigint GENERATED BY DEFAULT AS IDENTITY, "
+ "name varchar(20) NOT NULL, " + "company varchar(30), " + "cbt integer)");
} catch (SQLException e) {}

        Random rand = new Random();
        PreparedStatement addCandleStmt = connection.prepareStatement("INSERT INTO Candle (name, company, cbt) VALUES (?, ?, ?)",
...
public void checkGettingFailure() throws SQLException {
    candleManager.getCandle(1000);
}
...
public void checkUpdatingFailure() throws SQLException {
    Candle c = new Candle("Mango","Pronto", 1754);
    candleManager.updateCandle(c);
}
}
